...
<?php //if ( ( bp_get_current_profile_group_id() != 4 ) || ( current_user_can('editor') ) ) {  ?>
<?php if ( ( bp_get_current_profile_group_id() == 1 ) || ( bp_get_current_profile_group_id() == 2 ) || ( bp_get_current_profile_group_id() == 4 ) || ( current_user_can( 'editor' ) ) ) {  ?>
