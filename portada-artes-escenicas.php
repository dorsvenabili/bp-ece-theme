<?php
	/*
		Template Name: Portada Artes Escénicas
	*/
?>
<?php get_header() ?>
	...
	<div id="content">
		...
		<div class="slide-home">
			...
			noletia_show_main_slide('artes-escenicas');
		...
		<div class="page" id="blog-page" role="main">
			...
			<div class="conc-y-desc-home">
				<div class="bloque-concursos">
					...
					<div>
						...
						<?php //mostrar_ult_post_concursos('artes-escenicas'); ?>
					</div>
				</div>
				<div class="bloque-descuentos">
					<?php /* ?><h2 class="title-bloque1 size16 font-normal">Descuentos</h2><?php */ ?>
					<div>
						<?php mostrar_ult_post_descuentos('artes-escenicas'); ?>
					</div>
				</div>
			</div>
			...
			<div class="bloque-agenda">
				<?php mostrar_ult_post_agenda('artes-escenicas'); ?>
			</div>
			<?php */ ?>
			
			
			<div class="bloque-agenda">
				<?php mostrar_ult_post_agenda2('artes-escenicas'); ?>
			</div>
			
			
			<div class="last-news-home">
				<?php mostrar_ult_post_noticias('artes-escenicas'); ?>
			</div>
			
			
			<div class="last-news-home">
				<?php mostrar_ult_post_noticias_seg_fila('artes-escenicas'); ?>
			</div>
			
			<div id="more_news_frontpage">
				<h2 class="all_desc_frontpage_title orange">Más noticias</h2>
				<?php mostrar_modulos_peq_portadas('artes-escenicas', 8); ?>
				<?php mostrar_enlace_ver_todas_noticias('artes-escenicas'); ?>
			</div>
