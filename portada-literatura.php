<?php
	/*
		Template Name: Portada Literatura
	*/
?>
<?php get_header() ?>
	...
	<div id="content">
		...
		<div class="slide-home">
			...
			noletia_show_main_slide('literatura');
		...
		<div class="page" id="blog-page" role="main">
			...
			<div class="bloque-agenda">
				<?php mostrar_ult_post_agenda('literatura'); ?>
			</div>
			<?php */ ?>
			
			
			<div class="bloque-agenda">
				<?php mostrar_ult_post_agenda2('literatura'); ?>
			</div>
			
			
			<div class="last-news-home">
				<?php mostrar_ult_post_noticias('literatura'); ?>
			</div>
			
			
			<div class="last-news-home">
				<?php mostrar_ult_post_noticias_seg_fila('literatura'); ?>
			</div>
			
			<div id="more_news_frontpage">
				<h2 class="all_desc_frontpage_title orange">Más noticias</h2>
				<?php mostrar_modulos_peq_portadas('literatura', 8); ?>
				<?php mostrar_enlace_ver_todas_noticias('literatura'); ?>
			</div>
