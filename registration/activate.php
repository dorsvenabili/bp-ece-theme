	...
	<div id="content">
		...
		<div class="page" id="activate-page">
			...
			<?php else : ?>
				...
				<p>Si te aparece esta página pero ya has activado tu cuenta por correo electrónico, pulsa sobre la cabecera para <a href="http://elclubexpress.com">navegar por el sitio</a> o sobre tu nombre para editar tu perfil. </p>
